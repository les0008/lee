...
const PLAN = {
  ...
  '04': ['photoPanel', 'sand',  false, 'center center' ],
  ...
  '29': ['photoPanel', 'sand',  false, 'center center' ],
  '30': ['photoPanel', 'stone', true,  'center 70%' ],
  '31': ['photoPanel', 'sand',  false, 'center center' ],
